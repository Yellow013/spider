...
////需要实现MessageListener接口，这个接口有个onMessage方法，当接受到消息的时候会自动调用这个函数对消息进行处理
...
//	
//	public ConsumerTool() throws JMSException, Exception{
//		initialize();
//	}
//
//	// 初始化
...
//				Request deSerializeOrder;
//				try {
//					deSerializeOrder = (Request) avroSerialization.deSerialize(bytes);
//					System.out.println(deSerializeOrder);
//				} catch (Exception e) {
//					e.printStackTrace();
//				}
